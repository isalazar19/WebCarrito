        ...
        public List<Marca> ListarMarcaporCategoria(int idcategoria)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(Conexion.cn))
                {
                    ...
                    sb.AppendLine("select  max(m.IdMarca) as IdMarca,m.Descripcion from PRODUCTO p");
                    //sb.AppendLine("select m.IdMarca,m.Descripcion from PRODUCTO p");
                    ...
                    sb.AppendLine("GROUP BY m.Descripcion");
